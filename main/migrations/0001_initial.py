    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_clup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='new_club', to='main.club')),
                ('old_clup', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='old_club', to='main.club')),
